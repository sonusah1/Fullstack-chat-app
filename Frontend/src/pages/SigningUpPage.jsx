...
import { MessageSquare, User, Eye, EyeOff, Mail } from "lucide-react";
...
function SigningUpPage() {
  ...
  const validateForm = () => {
    ...
    if (!fullName.trim()) {
      return toast.error("Full name are required");
    }
    if (!email.trim()) {
    ...
    return (
      <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <AuthImagePattern
          ...
          subtitle="Connect with friends,share Moments,and stay in touch with fiends"
        />
      </div>
    );
  }
